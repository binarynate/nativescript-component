...
class ComponentManager {
    ...
    */
    _addNewComponent(view) {
        ...
        // view is unloaded.
        view.on(_page.Page.unloadedEvent, options => {
        ...
        */
        this[methodName] = (...args) => {
            ...
            if (this.componentClass.isSingleton) {
                ...
                if (!component) {
                    let message = `Method '${methodName}' called for singleton component ${this.componentClass.name}, ` + `but the component has not been instantiated yet. Please ensure that one of the component's ` + `lifecycle hooks (e.g. onLoaded, onNavigatingTo) are hooked up in its template.`;
