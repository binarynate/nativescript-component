...
exports.getBindingContextProperty = getBindingContextProperty;
exports.getComponentForView = getComponentForView;
...
* @private
*/
function getBindingContextProperty(bindingContext, propertyName) {
...
function getComponentForView(view) {
    ...
    if (view.bindingContext && getBindingContextProperty(view.bindingContext, '_component')) {
        ...
        var component = getBindingContextProperty(view.bindingContext, '_component');
        return component;
    }
